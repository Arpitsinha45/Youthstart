...
import { Plus, Edit2, Trash2, Image as ImageIcon, Sparkles, Star, Loader2 } from 'lucide-react';
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="relative group">
              {coverImage ? (
                ...
                <div className="w-full h-64 border-2 border-dashed border-white/10 rounded-2xl flex flex-col items-center justify-center text-gray-500 hover:border-white/20 hover:bg-white/5 transition-all">
